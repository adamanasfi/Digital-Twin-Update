...
namespace RosMessageTypes.CustomedInterfaces
{
    ...
    {
        public const string k_RosMessageName = "customed_interfaces/HuskyStatus";
        ...
        public HuskyStatusMsg(string name, double left_driver_current, double right_driver_current, double battery_voltage, float battery_percentage, double left_driver_voltage, double right_driver_voltage, double left_driver_temp, double right_driver_temp, double left_motor_temp, double right_motor_temp, bool timeout, bool lockout, bool e_stop, bool ros_pause, bool no_battery, bool current_limit)
        {
            this.name = name;
